...
export default function TextToolsPage() {
  ...
  return (
    <ToolPageWrapper title="Text Tools" description="Diff, Markdown preview & word counter" emoji="✏️">
      ...
      {tab === 'diff' && (
        <div className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <label className="text-sm text-gray-400 mb-2 block">Text A (Original)</label>
            ...
            <div>
              <label className="text-sm text-gray-400 mb-2 block">Text B (Modified)</label>
              <textarea className="textarea-field font-mono text-xs" style={{ minHeight: '250px' }}
          ...
          {(textA || textB) && (
            <div className="tool-card p-4">
              <h3 className="text-sm font-semibold mb-3 text-gray-300">Diff Result</h3>
      ...
      {tab === 'markdown' && (
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <label className="text-sm text-gray-400 block mb-2">Markdown Input</label>
